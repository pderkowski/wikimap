...
$(AGGREGATEOBJECTS) : CXXFLAGS += -I$(SNAPDIR)/snap-core -I$(SNAPDIR)/glib-core
$(AGGREGATEBIN) : CXXFLAGS += -O3 -DNDEBUG -fopenmp -lrt
$(NODE2VECBIN) : CXXFLAGS += -O3 -DNDEBUG -fopenmp -lrt -I$(SNAPDIR)/snap-core -I$(SNAPDIR)/glib-core
...
build: $(PAGERANKBIN) $(SQLTOOLSLIB) $(TSNEBIN) $(AGGREGATEBIN) $(NODE2VECBIN)
